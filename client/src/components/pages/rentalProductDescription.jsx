...
import "./rentalProductDescription.css";
import { ShieldCheck, Star, ShoppingBag } from 'lucide-react';
...
const RentalProductDetail = () => {
        ...
        if (response.data && (response.data.data || Array.isArray(response.data))) {
          ...
          if (savedReviews) {
            ...
            if (parsedReviews.length > 0) {
              const avg = parsedReviews.reduce((sum, review) => sum + review.rating, 0) / parsedReviews.length;
              setAverageRating(avg);
            }
          }
        }
  ...
  return (
    <div className="PD_product_detail_page">
      <div className="PD_product-detail">
        <div className="PD_product-container">
          <div className="PD_back-button" onClick={() => navigate(-1)}>
            <IonIcon icon={arrowBackOutline} />
          </div>
